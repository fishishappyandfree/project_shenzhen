...
from models.MT3_micphone.CNN_model import CNN
from models.MT3_micphone.Config import Config
...
class Model(object):
    ...
    def run_train(self, samples_train, labels_train, checkpoint_path_folder):
        ...
        self.config_train.learning_rate = 0.01  
        self.config_train.dropout_keep_prob_fc = 0.5 
        self.config_train.batch_size = 2048
