...
# 每个片段增强后的样本数
enhance_num = 300
mat_save_path = r"MT2_y_feed_dataset"


# =============================================== 读取matlab 文件 =======================================================
def load_mat_func(file_path):
    return io.loadmat(file_path)['MT2_feed_y'].T
...
# normal
normal_folder_path = '/home/hust/Desktop/wzs/MT2_X_feed/MT2_X_and_y_feed_data/normal/'
...
# Inner Raceway
inner_folder_path = '/home/hust/Desktop/wzs/MT2_X_feed/MT2_X_and_y_feed_data/inner_0.6_0.04/'
...
# Outer Raceway
outer_folder_path = '/home/hust/Desktop/wzs/MT2_X_feed/MT2_X_and_y_feed_data/outer-0.6-0.04_criticalG/'
