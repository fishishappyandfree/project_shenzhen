...
fault_directory = "C:/Users/数据采集/Desktop/新建文件夹 (2)/ae_analysis/MT3_y_feed/MT3_y_feed_data/"
...
for filename_index in range(len(filename_list)):
    ...
    MT3_y_feed_axis_data = tdms_content.object('未命名', 'cDAQ9189-1D71297Mod4/ai1').data
    ...
    savemat('MT3_y_feed_mat/' + filename_list[filename_index].rstrip('.tdms')+'.mat',
    #         # dict(spindle_x=spindle_x, spindle_y=spindle_y, spindle_z=spindle_z))
            dict(MT3_y_feed_axis_data=MT3_y_feed_axis_data))